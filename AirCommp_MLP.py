...
from MLP import NeuralNetwork  # OBS! Vi kommer ändra MLP:n lite längre ner
...
# Anpassad MLP för CIFAR10 (32x32x3 = 3072 input dimension)
...
plt.title('AirComp-baserad Federated Learning på CIFAR-10 (MLP)')
plt.grid()
plt.savefig("aircomp_federated_learning_convergence_cifar10_mlp.png")
print("Plott sparad som aircomp_federated_learning_convergence_cifar10_mlp.png")
