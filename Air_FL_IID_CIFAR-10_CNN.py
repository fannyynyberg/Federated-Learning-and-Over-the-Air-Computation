...
plt.xlabel('Round')
plt.ylabel('Accuracy (%)')
plt.title('AirComp IID CIFAR-10 CNN Convergence')
plt.grid()
plt.savefig("aircomp_iid_cifar10_cnn_convergence.png")
print("Figure saved as aircomp_iid_cifar10_cnn_convergence.png")
