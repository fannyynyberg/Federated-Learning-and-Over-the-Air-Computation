...
plt.xlabel('Round')
plt.ylabel('Accuracy (%)')
plt.title('AirComp Federated Learning on CIFAR-10')
plt.grid()
plt.savefig("aircomp_federated_learning_cifar10.png")
print("Plot saved as aircomp_federated_learning_cifar10.png")
