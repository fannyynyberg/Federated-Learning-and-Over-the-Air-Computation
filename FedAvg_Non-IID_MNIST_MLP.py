...
plt.xlabel('Round')
plt.ylabel('Accuracy (%)')
plt.title('FedAvg Non-IID MNIST MLP Convergence')
plt.grid()
plt.savefig("fedavg_non_iid_mnist_mlp_convergence.png")
print("Figure saved as fedavg_non_iid_mnist_mlp_convergence.png")
