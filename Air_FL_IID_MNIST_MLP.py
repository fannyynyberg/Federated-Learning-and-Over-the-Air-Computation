...
plt.xlabel('Round')
plt.ylabel('Accuracy (%)')
plt.title('Over-the-Air FL IID MNIST MLP Convergence')
plt.grid()
plt.savefig("air_fl_iid_mnist_mlp_convergence.png")
print("Figure saved as air_fl_iid_mnist_mlp_convergence.png")
